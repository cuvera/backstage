...
class TranscriptionRepositoryError(Exception):
    """Raised when the transcription repository cannot complete its task."""


class TranscriptionRepository(BaseRepository):
    """Repository for transcription data persistence."""
    ...
    @classmethod
    async def from_default(cls, collection_name: str = COLLECTION_NAME) -> "TranscriptionRepository":
    ...
    async def save_transcription(
        ...
        try:
            ...
            raise TranscriptionRepositoryError(f"Failed to save transcription: {exc}") from exc
    ...
    async def get_transcription(self, meeting_id: str, tenant_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            raise TranscriptionRepositoryError(f"Failed to get transcription: {exc}") from exc
    ...
    async def delete_transcription(self, meeting_id: str, tenant_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise TranscriptionRepositoryError(f"Failed to delete transcription: {exc}") from exc